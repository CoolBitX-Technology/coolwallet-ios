//
//  UIViewController+ReciveCoinViewContorller.m
//  CoolWallet
//
...
#import "ReciveCoinViewContorller.h"
#import "SWRevealViewController.h"

@implementation ReciveCoinViewContorller : UIViewController

- (void)viewDidLoad
{
    [super viewDidLoad];
    
    self.title = NSLocalizedString(@"Recive Coin", nil);
